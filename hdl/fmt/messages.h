 ...
 *
 * Supported here (Phase-1 reference slice): specifiers % c s d i u x X o b B p,
 * flags - 0 # + space, field width 0..63, and the l (32-bit) length modifier.
 * NOT yet: precision (.N) and * - k_fmtgen rejects formats using them.
 */
